...
div = read.csv("datos.csv")
```

```{r include=FALSE}
etiquetas = c(1,2,3,4,5)
div$ord = cut(div$dato,
              breaks = 5,
              labels = etiquetas,
              ordered_result = T)
```
...
```{r include=FALSE}
#Rango 1 va entre 0 y 5.05%
min(div[div$ord == 1,]$dato)
max(div[div$ord == 1,]$dato)
```

```{r include=FALSE}
#Rango 2 va entre 5.09% y 10.12%
min(div[div$ord == 2,]$dato)
max(div[div$ord == 2,]$dato)
```

```{r include=FALSE}
#Rango 3 va entre 10.32% y 15.25%
min(div[div$ord == 3,]$dato)
max(div[div$ord == 3,]$dato)
```

```{r include=FALSE}
#Rango 4 va entre 15.34% y 20.08%
min(div[div$ord == 4,]$dato)
max(div[div$ord == 4,]$dato)
```

```{r include=FALSE}
#Rango 5 va entre 20.76% y 25.43%
min(div[div$ord == 5,]$dato)
max(div[div$ord == 5,]$dato)
```
...
```{r diffdis1,echo=FALSE,message=FALSE,warning=FALSE,eval=TRUE,fig.show='hold',fig.width=10,fig.height=6}
library(maps)
